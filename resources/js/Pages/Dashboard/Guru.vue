                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4">
                            ...
                            <div class="bodyModal text-start">
                                <form @submit.prevent="submit">
                                    <div>
                                        <label for="namaguru" class="block text-sm font-medium text-slate-700">Nama Guru</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="usernamaguru" class="block text-sm font-medium text-slate-700">Username guru</label>
                                        <input id="usernameguru" v-model="form.username"
                                            type="text" autocomplete="off" required
                                            class="w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div class="mt-4">
